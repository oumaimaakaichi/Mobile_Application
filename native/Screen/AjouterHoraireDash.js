...
import { Animated, Image, SafeAreaView, StyleSheet, Text, TouchableOpacity, View ,ScrollView , Dimensions } from 'react-native';
...
import affiche from '../assets/aff.png'
...
export default function DashboardHoraire({ navigation }) {
...
console.log(AsyncStorage.getItem("station"))
 ...
 <ScrollView  style={{marginVertical: 0}}>
        ...
        }}>Ajouter vos Horaires du travail</Text>
        <Image source={affiche} style={{width:WIDTH , height:420 , alignSelf:'center'} } />
